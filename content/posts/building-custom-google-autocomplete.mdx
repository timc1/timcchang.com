...
But if we want to create a custom experience, we'll have to use Google's Autocomplete
REST endpoint to return the suggestions, and pass that along to our custom rendered component. (We
