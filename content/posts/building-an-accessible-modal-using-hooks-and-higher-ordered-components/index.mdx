---
title: 'Building A Modal Using React Portal, Higher Ordered Components, and Hooks'
...
I will be using Typescript (new to Types, ping me to help 🙂). A live demo of our `Modal` component can be found on [CodeSandbox]().
...
Lastly, let's define out keydown event handler:
