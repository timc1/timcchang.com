...
easily crawl the page and for users to easily navigate throughout the page using accessibility
technologies."
/>

Everything was built from scratch with no UI libraries. The site is currently in approval process —
for a link please email me!
